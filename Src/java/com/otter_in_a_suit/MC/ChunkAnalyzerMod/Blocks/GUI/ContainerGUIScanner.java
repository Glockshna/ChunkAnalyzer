...
/*
 * http://www.minecraftforum.net/topic/1959857-162-advanced-minecraft-forge-modding-tutorial-2-
 * inventories/
 */
...
class ContainerGUIScanner extends Container {
  ...
  /*
   * Prevent crash from shift-click (non-Javadoc)
   * 
   * @see
   * net.minecraft.inventory.Container#transferStackInSlot(net.minecraft.entity.player.EntityPlayer,
   * int)
   */
  @Override
